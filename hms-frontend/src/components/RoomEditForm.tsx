    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label>
          ...
          <input required className={inputCls} type="number" min="0" step="100" value={formData.baseRate || ''} onChange={(e) => handleChange('baseRate', e.target.value === '' ? 0 : Number(e.target.value))} />
        </label>
      </div>
