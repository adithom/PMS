...
import { RefreshCw, Pencil, Trash2, CirclePause, CirclePlay } from 'lucide-react';
      ...
      <div className="flex flex-col flex-1 min-h-0 mx-auto w-full max-w-[1800px] px-8 sm:px-12 lg:px-16">
        ...
        <div className="flex items-center justify-between flex-shrink-0 pt-4 pb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <RefreshCw className={restarting ? 'w-3.5 h-3.5 animate-spin' : 'w-3.5 h-3.5'} />
                          ...
                          <td className="px-5 py-2 text-right">
                            <div className="inline-flex items-center gap-1">
                              ...
                              <button type="button" onClick={() => handleToggleAgent(a)}
                                ...
                                {a.active ? <CirclePause className="h-3.5 w-3.5" /> : <CirclePlay className="h-3.5 w-3.5" />}
                              </button>
