### immediate
- [x] early checkouts 
- [x] no show should release room and clean up chart
- [x] release rooms after early checkout
- [x] extend bookings
- [x] group bookings
- [x] twin bedded field for booking
...
### long term
- [ ] Export to Excel/CSV button (bookings, bills)
